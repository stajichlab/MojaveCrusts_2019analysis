...
Heatmap.sitelayer.endemic.plot = plot_heatmap(Heatmap.sitelayer.endemic, "PCoA", "unifrac", "Site_layer", "Phylum")+ ggtitle("Bacterial endemic species heatmap (top 50 ASVs)") + theme(plot.title = element_text(hjust = 0.5))
print(Heatmap.sitelayer.endemic.plot)

ggsave("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/MojaveCrusts_2019analysis/EndemicSpecies/Bacteria/Figures/Bacterial_endemic_species_heatmap_top50.png", plot = Heatmap.sitelayer.endemic.plot, width = 12, height = 8)
```
...
```{r}
pdf("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/MojaveCrusts_2019analysis/EndemicSpecies/Bacteria/Figures/Endemic_Proteo_top50.pdf" )
plot_tree(Heatmap.sitelayer.endemic.proteo, nodelabf=nodeplotboot(), ladderize="left", color="Site_layer", label.tips = "Genus", text.size = 2) + ggtitle("Endemic Proteobacteria tree (top 50 ASVs)") + theme(plot.title = element_text(hjust = 0.5))
dev.off()
```
