...
Heatmap.sitelayer.endemic.plot = plot_heatmap(Heatmap.sitelayer.endemic, "PCoA", "bray", "Site_layer", "Phylum")+ ggtitle("Fungal endemic species heatmap (top 100 OTUs)") + theme(plot.title = element_text(hjust = 0.5))
print(Heatmap.sitelayer.endemic.plot)

ggsave("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/MojaveCrusts_2019analysis/EndemicSpecies/Fungi/Figures/Fungal_endemic_species_heatmap_top100.png", plot = Heatmap.sitelayer.endemic.plot, width = 8, height = 10)
```
...
ggsave("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/MojaveCrusts_2019analysis/EndemicSpecies/Fungi/Figures/Endemic Ascomycota Heatmap.png", plot = Heatmap.sitelayer.endemic.asco.plot, width = 8, height = 10)
