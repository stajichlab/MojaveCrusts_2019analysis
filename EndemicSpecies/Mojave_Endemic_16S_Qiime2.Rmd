...
author: "Nat Pombubpa"
date: "Updated on February 5, 2019"
...
###Note:Documentation for Mojave 16S data using Qiime2 Silva extracted length classifier
This is a documentation for otu table, taxonomy table, and tree which were generated from Qiime2 using DADA2 and Silva database classifier extracted lenght (515-806). Note: Mitochondria and Chloroplast have been filterd and removed from OTU table.
...
Heatmap.sitelayer.endemic.cyano.plot = plot_heatmap(Heatmap.sitelayer.endemic.cyano, "PCoA", "unifrac", "Site_layer", "Family")+ ggtitle("Cyanobacteria heatmap") + theme(plot.title = element_text(hjust = 0.5))
print(Heatmap.sitelayer.endemic.cyano.plot)

#ggsave("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/Mojave_Project/Mojave_16S_Qiime2/Figures/Cyanobacteria Heatmap by Site and Layer.png", plot = Heatmap.sitelayer.cyano.plot, width = 8, height = 10)
...
```{r}
plot_tree(Heatmap.sitelayer.endemic.cyano, nodelabf=nodeplotboot(), ladderize="left", color="Site_layer", label.tips = "Genus", text.size = 2) 
```

```{r}
pdf("/Volumes/GoogleDrive/My Drive/UCR2019/Mojave_project2019/Mojave_Project/Mojave_16S_Qiime2/Figures/Endemic/Endemic_Cyano_top100.pdf" )
plot_tree(Heatmap.sitelayer.endemic.cyano, nodelabf=nodeplotboot(), ladderize="left", color="Site_layer", label.tips = "Genus", text.size = 2) 
dev.off()
```
...
Heatmap.sitelayer.endemic.protep.plot = plot_heatmap(Heatmap.sitelayer.endemic.proteo, "PCoA", "unifrac", "Site_layer", "Family")+ ggtitle("Proteobacteria heatmap") + theme(plot.title = element_text(hjust = 0.5))
print(Heatmap.sitelayer.endemic.protep.plot)
```
