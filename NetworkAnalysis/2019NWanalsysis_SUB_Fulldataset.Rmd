...
author: "Nat Pombubpa"
date: "Updated on February 7, 2019"
...
meta <- meta[which(meta$Layer %in% c("Subsurface")),]
...
```{r}
physeq.prune = subset_taxa(physeq.prune, Kingdom != "Plantae")
...
```{r}
pdf("Figures/Biocrust Microbial Community Network Analysis Subsurface.pdf", width = 18, height = 18)
chordDiagram(cdf.w.tax, annotationTrack = "grid", annotationTrackHeight = 0.01, preAllocateTracks = 1, link.visible = cdf.w.tax[[3]] > 0.75)
for(si in get.all.sector.index()) {
    xlim = get.cell.meta.data("xlim", sector.index = si, track.index = 1)
    ylim = get.cell.meta.data("ylim", sector.index = si, track.index = 1)
...
title(main = "Biocrust Microbial Community Network Analysis (Subsurface)")
circos.clear()
dev.off()
```

```{r}
sample_data(ps.taxglom)
```


##Network analysis for LAC crust type
```{r}
ps.taxglom.LAC = subset_samples(ps.taxglom, Crust_type=="LAC.Sub")
ps.taxglom.LAC
```

```{r warning=FALSE}
set.seed(711L)
psplotnet = plot_net(ps.taxglom.LAC, distance = "bray", type = "taxa", laymeth = "circle", color = "Phylum", point_label ="Phylum", hjust = 0.3, maxdist = 0.25) + ggtitle("Biocrust Microbial Community Network Analysis (LAC-subsurface")  + theme(plot.title = element_text(hjust = 0.5))
...
```{r}
pdf("Figures/Biocrust Microbial Community Network Analysis LAC Subsurface.pdf", width = 18, height = 18)
chordDiagram(cdf.w.tax, annotationTrack = "grid", annotationTrackHeight = 0.01, preAllocateTracks = 1, link.visible = cdf.w.tax[[3]] > 0.8)
for(si in get.all.sector.index()) {
    xlim = get.cell.meta.data("xlim", sector.index = si, track.index = 1)
    ylim = get.cell.meta.data("ylim", sector.index = si, track.index = 1)
...
title(main = "Biocrust Microbial Community Network Analysis (LAC-Subsurface)")
circos.clear()
dev.off()
```
...
```{r}
ps.taxglom.CLC = subset_samples(ps.taxglom, Crust_type=="CLC.Sub")
ps.taxglom.CLC
```

```{r warning=FALSE}
set.seed(711L)
psplotnet = plot_net(ps.taxglom.CLC, distance = "bray", type = "taxa", laymeth = "circle", color = "Phylum", point_label ="Phylum", hjust = 0.3, maxdist = 0.25) + ggtitle("Biocrust Microbial Community Network Analysis (CLC-Subsurface")  + theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
pdf("Figures/Biocrust Microbial Community Network Analysis CLC Subsurface.pdf", width = 18, height = 18)
chordDiagram(cdf.w.tax, annotationTrack = "grid", annotationTrackHeight = 0.01, preAllocateTracks = 1, link.visible = cdf.w.tax[[3]] > 0.8)
for(si in get.all.sector.index()) {
    xlim = get.cell.meta.data("xlim", sector.index = si, track.index = 1)
    ylim = get.cell.meta.data("ylim", sector.index = si, track.index = 1)
...
title(main = "Biocrust Microbial Community Network Analysis (CLC-Subsurface)")
circos.clear()
dev.off()
```
...
```{r}
ps.taxglom.GLC = subset_samples(ps.taxglom, Crust_type=="GLC.Sub")
ps.taxglom.GLC
```

```{r warning=FALSE}
set.seed(711L)
psplotnet = plot_net(ps.taxglom.GLC, distance = "bray", type = "taxa", laymeth = "circle", color = "Phylum", point_label ="Phylum", hjust = 0.3, maxdist = 0.25) + ggtitle("Biocrust Microbial Community Network Analysis (CLC-Subsurface")  + theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
pdf("Figures/Biocrust Microbial Community Network Analysis GLC Subsurface.pdf", width = 18, height = 18)
chordDiagram(cdf.w.tax, annotationTrack = "grid", annotationTrackHeight = 0.01, preAllocateTracks = 1, link.visible = cdf.w.tax[[3]] > 0.8)
for(si in get.all.sector.index()) {
    xlim = get.cell.meta.data("xlim", sector.index = si, track.index = 1)
    ylim = get.cell.meta.data("ylim", sector.index = si, track.index = 1)
...
title(main = "Biocrust Microbial Community Network Analysis (GLC-Suburface)")
circos.clear()
dev.off()
```
...
```{r}
ps.taxglom.SMC = subset_samples(ps.taxglom, Crust_type=="SMC.Sub")
ps.taxglom.SMC
```

```{r warning=FALSE}
set.seed(711L)
psplotnet = plot_net(ps.taxglom.SMC, distance = "bray", type = "taxa", laymeth = "circle", color = "Phylum", point_label ="Phylum", hjust = 0.3, maxdist = 0.25) + ggtitle("Biocrust Microbial Community Network Analysis (CLC-Subsurface")  + theme(plot.title = element_text(hjust = 0.5))
```
...
```{r}
pdf("Figures/Biocrust Microbial Community Network Analysis SMC Subsurface.pdf", width = 18, height = 18)
chordDiagram(cdf.w.tax, annotationTrack = "grid", annotationTrackHeight = 0.01, preAllocateTracks = 1, link.visible = cdf.w.tax[[3]] > 0.8)
for(si in get.all.sector.index()) {
    xlim = get.cell.meta.data("xlim", sector.index = si, track.index = 1)
    ylim = get.cell.meta.data("ylim", sector.index = si, track.index = 1)
...
title(main = "Biocrust Microbial Community Network Analysis (SMC-Subsurface)")
circos.clear()
dev.off()
```
